...
<html>
  ...
  <body class="ContentBody">
	...
	<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  		<tr>
      		<th class="tablestyle_title" >新增名单页面</th>
  		</tr>
  		<tr>
    		<td class="CPanel">
					...
					<legend>新增名单</legend>
					  <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
						  ...
						  <tr>
						    ...
						    <td width="43%"><input id="name" name="XM" class="text" style="width:154px" type="text" />
					        <span class="red"> *</span></td>
					        <td align="right" width="17%">单位:</td>
						    <td width="27%"><input id="dw" name="DW"  class="text" style="width:154px" />
						     <span class="red"> *</span></td></td>
					  	  <tr>
						    <td nowrap align="right">等级:</td>
						    <td>
						    	<input id ="dj" name="DJ"  class="text" style="width:154px" />
						     <span class="red"> *</span></td></td>
					 	 </tr>
				</table>
				 <br />
